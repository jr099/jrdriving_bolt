    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden transform hover:scale-105 transition-transform">
              ...
              <div className="p-8">
                ...
                <Link
                  href="/devis"
                  className="block w-full px-6 py-3 text-center bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition-colors"
                >
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden transform hover:scale-105 transition-transform">
              ...
              <div className="p-8">
                ...
                <Link
                  href="/devis"
                  className="block w-full px-6 py-3 text-center bg-orange-600 hover:bg-orange-700 text-white font-semibold rounded-lg transition-colors"
                >
      ...
      <section className="py-20 bg-slate-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold mb-6">Une question sur nos services?</h2>
          <p className="text-xl text-gray-300 mb-8">Notre équipe est à votre disposition pour vous conseiller</p>
