        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 space-y-8">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">jrdriving propose les services suivants :</p>
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">Toute annulation ou modification doit être notifiée par écrit :</p>
              <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
