      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white py-24">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6">jrdriving</h1>
            <p className="text-2xl md:text-3xl font-light mb-4 text-gray-200">
              Votre partenaire logistique pour le transport
            </p>
            <p className="text-xl md:text-2xl mb-8 text-orange-400">rapide et sécurisé de vos véhicules</p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-4">Pourquoi choisir jrdriving?</h2>
            <p className="text-xl text-gray-600">Des solutions de convoyage professionnelles adaptées à vos besoins</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-gradient-to-br from-orange-50 to-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow border border-orange-100">
              ...
              <p className="text-gray-600">Convoyage express disponible 7j/7 avec une prise en charge sous 24h</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow border border-blue-100">
              ...
              <p className="text-gray-600">Chauffeurs professionnels certifiés et véhicules assurés tous risques</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow border border-green-100">
              ...
              <p className="text-gray-600">Plus de 15 ans d'expérience dans le convoyage automobile professionnel</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow border border-purple-100">
              ...
              <p className="text-gray-600">98% de clients satisfaits et un service client disponible 6j/7</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-br from-slate-50 to-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-slate-900 mb-6">Nos clients nous font confiance</h2>
              <p className="text-lg text-gray-700 mb-6">
                Depuis plus de 15 ans, nous accompagnons les professionnels de l'automobile et les particuliers dans leurs besoins
                de convoyage.
              </p>
              ...
              <Link
                href="/services"
                className="mt-8 inline-flex px-6 py-3 bg-orange-600 hover:bg-orange-700 text-white font-semibold rounded-lg transition-colors"
              >
                En savoir plus
              </Link>
            </div>
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-xl">
                  <p className="text-gray-700">
                    "jrdriving nous accompagne depuis 5 ans. Leur réactivité et la qualité de leurs chauffeurs sont irréprochables."
                  </p>
                  <p className="mt-3 text-sm text-gray-500">Sophie L. - Responsable logistique, MobilityPro</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-xl">
                  <p className="text-gray-700">
                    "Livraison de mon véhicule à domicile en 24h, parfait! Le suivi en temps réel rassure énormément."
                  </p>
                  <p className="mt-3 text-sm text-gray-500">Julien R. - Particulier</p>
                </div>
              </div>
            </div>
          </div>
