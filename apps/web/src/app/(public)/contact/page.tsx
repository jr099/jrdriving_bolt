    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-12 text-center">
          ...
          <p className="text-gray-600">Merci pour votre message. Notre équipe vous répondra dans les plus brefs délais.</p>
        </div>
      </div>
    );
  }
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
              <div className="h-full min-h-[600px] bg-gray-200 flex items-center justify-center">
                <div className="text-center p-8">
                  ...
                  <p className="text-gray-600">Notre siège social est situé à Paris</p>
                  <p className="text-sm text-gray-500 mt-4">Intégration Google Maps disponible</p>
                </div>
              </div>
            </div>
          </div>
