...
import { updateMissionStatus as updateMissionStatusRequest } from '../../../lib/api';
...
export default function DriverDashboardPage() {
  ...
  const { data, error, isLoading, refresh } = useDriverDashboard({ enabled: profile?.role === 'driver' });
      ...
      {isLoading && !data ? (
        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
          <div className="bg-white shadow-lg rounded-xl p-8 text-center max-w-md">
            ...
            <h2 className="text-xl font-semibold text-slate-900 mb-2">Impossible de charger vos missions</h2>
                      ...
                      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                        <div className="flex-1 mb-4 lg:mb-0">
                          <div className="flex items-center gap-3 mb-3">
                            <span className="font-mono font-semibold text-slate-900">{mission.missionNumber}</span>
                            <span
                              className={`px-3 py-1 rounded-full text-xs font-semibold ${getStatusColor(mission.status)}`}
                            >
